...
not optimize temporal lag, fit hydraulic parameters, or resolve droplets as
moving multiphase CFD objects. It does include a validated steady Stokes
full-device CFD solve for the continuous phase, a physics-enriched canonical
training dataset, a physics-embedded Markovian rollout model, and a
self-contained rollout comparison against the two previous Markovian baselines.
...
\texttt{src/evaluation/} & Self-contained rollout comparison bundle for baseline and physics-embedded models. \\
\texttt{src/datasets/} & Canonical dataset builders and window loaders. \\
\texttt{src/models/} & Transformer model architecture used by the physics Markovian trainer. \\
...
\texttt{scripts/training/} & Physics Markovian training and attention visualization entry points. \\
