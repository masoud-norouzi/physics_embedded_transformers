...
The current implementation is deterministic and data-preparatory. It does not
train a transformer, solve Navier--Stokes equations, optimize temporal lag,
fit hydraulic parameters, or compute velocity interpolation fields for ML use.
...
\texttt{src/physics/cfd/} & CFD domain and mesh infrastructure; solver placeholders only. \\
